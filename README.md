# 🍎 GidaX - AI-Powered Food Analysis
...
# .env dosyası oluştur
echo "VITE_CLAUDE_API_KEY=your-api-key-here" > .env.local
...
│   ├── ResultView.css               # Sonuç stilleri
│   ├── ProfileModal.jsx             # Profil ayarları
│   └── History.jsx                  # Geçmiş listesi
├── data/
...
### Skor Faktörleri
- **Şeker Seviyesi** (-15 puan yüksek, -8 orta)
- **Yağ Seviyesi** (-12 puan yüksek, -6 orta)
- **Doymuş Yağ** (-10 puan yüksek, -5 orta)
- **Tuz Seviyesi** (-8 puan yüksek, -4 orta)
...
### Haram E Kodları
- E120 (Cochineal), E441 (Gelatin), E542, E631, E635, E904, E920, E921

### Şüpheli E Kodları
- E471-478, E481-483, E491-495 (Hayvan kökenli emulsifier)

### Haram Malzemeler
- Domuz, alkol, şarap, bira, gelatin
...
Katkılar memnuniyetle kabul edilir! Lütfen:
...
- GitHub Issues: [https://github.com/scraper065/healtune/issues](https://github.com/scraper065/healtune/issues)
